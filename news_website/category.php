                ...
                <div class="col-12">
                    <div class="p-2 bg-primary d-flex justify-content-between align-items-center rounded">
                        ...
                        <div class="dropdown">
                            ...
                            <img src="img/user/me.jpg" class="user-img shadow-sm" alt=""> <?php echo $_SESSION['userName'] ?>
                            </button>
                            ...
                            <div class="my-3">
                                <table id="datatable" class="table table-bordered">
                                    ...
                                    <tr>
                                        <th>#</th>
                                        <th>Title</th>
                                        <?php if (user($_SESSION['userName'])->role == 0) { ?>
                                        <th>User</th>
                                        <?php } ?>
                                        <th>Control</th>
                                        <th>Created_at</th>
                                    ...
                                    <?php foreach (categories() as $row) { ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-nowrap"><?php echo short($row->title,50); ?></td>
                                                <?php if (user($_SESSION['userName'])->role == 0) { ?>
